...
const create_employee_profile_dto_1 = require("./create-employee-profile.dto");
const class_validator_1 = require("class-validator");
const employee_profile_enums_1 = require("../enums/employee-profile.enums");
class UpdateEmployeeProfileDto extends (0, swagger_1.PartialType)(create_employee_profile_dto_1.CreateEmployeeProfileDto) {
    status;
}
...
], UpdateEmployeeProfileDto.prototype, "status", void 0);
