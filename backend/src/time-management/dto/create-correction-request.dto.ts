...
export class CreateCorrectionRequestDto {
  @ApiProperty({
    ...
    description: 'Employee ID requesting correction',
  })
  @IsString()
  employeeId: string;
  ...
  @ApiProperty({
    ...
    example: [
      { type: 'IN', time: '2024-01-15T09:00:00Z' },
      { type: 'OUT', time: '2024-01-15T17:00:00Z' },
    ],
  })
  @IsArray()
  ...
  @ApiProperty({
    example: 'Forgot to punch out due to emergency',
