...
export class CreateShiftTypeDto {
  ...
  @ApiProperty({
    example: false,
    description: 'Is this a night shift?',
    required: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiProperty({
    example: false,
    description: 'Is this a weekend shift?',
    required: false,
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiProperty({
    example: 10,
    description: 'Grace period for early departure (minutes)',
    required: false,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    example: 'Standard 9-5 weekday shift',
