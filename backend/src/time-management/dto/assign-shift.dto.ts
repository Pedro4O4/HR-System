...
export class AssignShiftDto {
  @ApiProperty({
    ...
    description: 'Employee ID (for individual assignment)',
    required: false,
  })
  @IsMongoId()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'Department ID (for department-wide assignment)',
    required: false,
  })
  @IsMongoId()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'Position ID (for position-based assignment)',
    required: false,
  })
  @IsMongoId()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'Shift Type ID to assign',
  })
  @IsMongoId()
  shiftTypeId: string;
  ...
  @ApiProperty({
    ...
    description: 'End date of the shift assignment (null means ongoing)',
    required: false,
  })
  @IsDateString()
  @IsOptional()
