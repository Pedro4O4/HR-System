...
export class OrganizationStructureController {
  ...
  @ApiOperation({
    summary: 'Create organization structure change request',
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Approve organization change request',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Reject organization change request',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @Roles(...ALL_EMPLOYEE_ROLES)
  @ApiOperation({
    summary: 'Get positions in department',
    description: 'Allowed roles: All authenticated users',
  })
