...
export class PerformanceController {
  ...
  @ApiOperation({
    summary: 'Create appraisal template',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @ApiOperation({
    ...
    description: 'Allowed roles: HR Admin, HR Manager, HR Employee',
  })
  findAllTemplates() {
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Assign appraisal to employee',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Bulk assign appraisals',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Bulk publish appraisals',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @ApiOperation({
    summary: 'Get my appraisals (employee view)',
    description: 'Allowed roles: All authenticated users',
  })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Get my published appraisals',
    description: 'Allowed roles: All authenticated users',
  })
  ...
  @ApiOperation({
    summary: 'Get my team appraisals',
    description: 'Allowed roles: HR Admin, HR Manager, Department Head',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Allowed roles: HR Admin, HR Manager, HR Employee, Department Head',
  })
  ...
  @Roles('HR Admin', 'HR Manager', 'Department Head', 'HR Employee')
  @ApiOperation({
    summary: 'Submit manager feedback on appraisal',
    description: 'Allowed roles: HR Admin, HR Manager, Department Head',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Finalize and publish appraisal',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  finalizeAppraisal(
    @Param('id') id: string,
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Mark appraisal as viewed',
    description: 'Allowed roles: All authenticated users',
  })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Raise dispute on appraisal',
    description: 'Allowed roles: All authenticated users',
  })
  raiseDispute(
    @Param('id') id: string,
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Resolve appraisal dispute',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  resolveDispute(
    @Param('id') id: string,
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Get all appraisal disputes',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  findAllDisputes() {
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Get pending appraisals',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Get appraisal progress dashboard',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Get my appraisal history',
    description: 'Allowed roles: All authenticated users',
  })
  ...
  @ApiOperation({
    summary: 'Get employee appraisal history',
    description: 'Allowed roles: HR Admin, HR Manager, Department Head',
  })
  ...
  @Roles('HR Admin', 'HR Manager')
  @ApiOperation({
    summary: 'Get appraisal cycle report',
    description: 'Allowed roles: HR Admin, HR Manager',
  })
