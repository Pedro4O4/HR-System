...
async function seedRoles() {
  ...
  try {
    ...
    const EmployeeSystemRoleModel = mongoose.model(
      'EmployeeSystemRole',
      ...
      roles: [
        {
          ...
          biography:
            'Senior System Administrator with 15+ years of experience in enterprise systems management.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'HR Manager with expertise in recruitment, employee relations, and payroll management.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'HR Admin specialist in employee records management and administrative functions.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'HR Employee handling recruitment, onboarding, and employee engagement initiatives.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Department Head overseeing daily operations and managing team members.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Department Employee handling day-to-day operational tasks.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Payroll Manager responsible for salary processing and benefits administration.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Payroll Specialist handling payroll calculations and salary administration.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Recruiter specializing in talent acquisition and candidate management.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          biography:
            'Finance Staff member handling financial reports and budget management.',
          status: 'ACTIVE',
        ...
        },
        {
          ...
          bankAccountNumber: '3333444455',
          biography:
            'Legal & Policy Admin managing compliance and policy documentation.',
          status: 'ACTIVE',
    ...
    for (const roleEmployee of roleData.roles) {
      try {
        ...
        console.log(
          `✓ Created employee: ${savedEmployee.fullName} (${roleEmployee.systemRole})`,
        );
        ...
        console.error(
          `✗ Error creating ${roleEmployee.fullName}:`,
          error.message,
        );
      }
    }
    ...
    const PositionAssignmentModel = mongoose.model(
      'PositionAssignment',
    ...
    console.log(
      `✓ Created Positions: ${hrManagerPos.title}, ${hrEmployeePos.title}`,
    );

    // 3. Assign Employees to Positions
    const hrManagerEmp = await EmployeeProfileModel.findOne({
      workEmail: 'fatima.mohammed@company.com',
    });
    const hrEmployeeEmp = await EmployeeProfileModel.findOne({
      workEmail: 'karim.ibrahim@company.com',
    });
    ...
    if (hrManagerEmp) {
      ...
      console.log(
        `✓ Assigned ${hrManagerEmp.fullName} to ${hrManagerPos.title}`,
      );
    }
    ...
    if (hrEmployeeEmp) {
      ...
      console.log(
        `✓ Assigned ${hrEmployeeEmp.fullName} to ${hrEmployeePos.title}`,
      );
    }
